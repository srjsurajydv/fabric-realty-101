      ...
      <el-col v-for="(val,index) in donatingList" :key="index" :span="6" :offset="1">
        <el-card class="d-buy-card">
          <div slot="header" class="clearfix">
            ...
            <el-button v-if="val.donating.donatingStatus==='Donating'" style="float: right; padding: 3px 0" type="text" @click="updateDonating(val,'done')">Confirm receipt</el-button>
